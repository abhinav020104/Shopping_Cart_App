...
function Cart(){
  ...
  return(
    <div>
      {
        cart.length > 0 ? (
        <div className="lg:flex md:flex  sm:flex lg:flex-row  lg:justify-between lg:items-center md:flex-col sm:flex-col lg:mr-10 lg:ml-10 sm:flex-wrap md:flex-wrap">
        ...
        <div className="flex flex-col w-[30vw]  gap-5 justify-between h-[80vh]">
